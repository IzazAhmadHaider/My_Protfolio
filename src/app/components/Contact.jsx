...
function Contact() {
  return (
    <div className='bg-gradient-to-r from-yellow-400 to-orange-400 min-h-screen  flex justify-center items-center'>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="container mx-auto px-4 py-8 shadow-lg rounded-lg bg-white max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <form>
                <div className="mb-4">
                  <label className="block text-gray-500 font-semibold mb-2" htmlFor="name">Name</label>
                  <input className="w-full px-4 py-2 border rounded-md bg-gray-600" type="text" id="name" name="name" placeholder="Your Name" />
                </div>
                <div className="mb-4">
                  <label className="block text-gray-500 font-semibold mb-2" htmlFor="email">Email</label>
                  <input className="w-full px-4 py-2 border rounded-md bg-gray-600" type="email" id="email" name="email" placeholder="Your Email" />
                </div>
                <div className="mb-4">
                  <label className="block text-gray-500 font-semibold mb-2" htmlFor="message">Message</label>
                  <textarea className="w-full px-4 py-2 border rounded-md bg-gray-600" id="message" name="message" rows="4" placeholder="Your Message"></textarea>
                </div>
                <button className="bg-blue-400 text-white px-6 py-2 rounded-md hover:bg-orange-600" type="submit">Send Message</button>
              </form>
            </div>
            <div 
  style={{
  ...
  className='bg-gradient-to-br from-yellow-400 to-orange-400 w-80 h-60 rounded-xl shadow-2xl'
>
