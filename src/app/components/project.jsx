...
const MyComponent = () => {
  ...
  return (
    <div className="flex w-[90%]  h-[90%] overflow-auto py-2 pl-2">
      <div className="bg-transparent w-full py-2 pl-2">
        <h2 className="text-3xl text-[#4c4c4c]  font-bold text-center mb-12">Projects</h2>
